# Script to create/submit simulation jobs with automatic splitting of input for all events in given: iChannel, ifiles
...
lcinputpathx  = "LFN:/ilc/prod/ilc/mc-dbd/generated/"+str(energy)+"-TDR_ws/" 

idin = ireq + ix
if   ireq == "I106485" :
   infile = "E" + str(energy) + "-TDR_ws.Pqqh.Gwhizard-1_95.eL.pR." + idin
   lcinputpath  = lcinputpathx + "higgs/" 
   chann ="higgs"
elif   ireq == "I106486" :
...
job.setInputSandbox(["runSimSplit_all_Tmp.py"])
